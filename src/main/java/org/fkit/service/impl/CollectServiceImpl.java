...
public class CollectServiceImpl implements CollectService{
	...
	@Override
	public Collect findCollect(String loginname,Integer good_id) {
		// TODO Auto-generated method stub
		return collectMapper.findCollect(loginname,good_id);
	}

	
	@Override
	public Collect removeCollect(String loginname,Integer good_id) {
		// TODO Auto-generated method stub
		collectMapper.removeCollect(loginname,good_id);
		return collectMapper.findCollect(loginname,good_id);
	}
